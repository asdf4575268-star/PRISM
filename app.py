...
with tab_a:
    st.markdown("""<style>
        ...
        .badge-cat { position: absolute; top: 8px; left: 8px; background: rgba(0, 0, 0, 0.7); color: yellow; padding: 2px 8px; border-radius: 4px; font-size: 11px; font-family: 'Pretendard', 'Noto Sans KR', sans-serif;z-index: 10; }
